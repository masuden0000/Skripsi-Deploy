---
queries:
  - "Sistematika Penulisan Proposal PKM-RSH lampiran daftar isi daftar pustaka"
  - "Sistematika Proposal Kegiatan PKM riset sosial humaniora lampiran"
  - "format nama file PKM pengumpulan berkas proposal RSH"
  - "batas maksimum halaman bagian inti proposal PKM-RSH"
  - "biaya jadwal kegiatan sub bab proposal PKM-RSH anggaran"
  - "rekapitulasi anggaran biaya format tabel PKM riset sosial"
section_focus:
  - "SISTEMATIKA PENULISAN PROPOSAL"
  - "SISTEMATIKA PROPOSAL KEGIATAN"
---

# Tugas Ekstraksi: Struktur Dokumen Proposal PKM-RSH

## Konteks
{context}

## Tugas
Ekstrak struktur dokumen untuk jenis PROPOSAL PKM-RSH (Riset Sosial Humaniora) dari konteks di atas.
...
**JANGAN berhenti lebih awal jika dokumen sumber menyebutkan lebih.**
...
- Lampiran berikut adalah **referensi lampiran standar PKM-RSH** (bukan daftar final — dokumen sumber adalah otoritas tertinggi):
...
- Proposal PKM-RSH memiliki 4 BAB: BAB 1 sampai BAB 4. Pastikan semua 4 BAB hadir dalam sections.
...
Contoh sections untuk proposal PKM-RSH:
```json
[
